                ...
                while unbalanced:
                    ...
                    if np.any((p_rules < (stationary_distrib[0]-0.02)) | (p_rules > (stationary_distrib[0]+0.02))): 
                        ...
                        if max_count - min_count > 1: # max. difference of 1 trial between occurrences of deviant positions
                            ...
                            hgm.plot_combined_with_matrix(run_obj['states'][0], run_obj['states'][1], run_obj['obs'], run_obj['contexts'], run_obj['rules'], run_obj['dpos'], run_obj['pars'], pi_rules=run_obj['pi_rules'], text=False, plot_dpos_dist=True, save_path = None)
                            fig = plt.gcf() 
